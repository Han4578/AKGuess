...
from class_parser import parseSubClasses, updateClassSubclass
from faction_parser import parseFactions, updateFactionSubfaction
...
for id, o in op_list:
    factions = [v for v in (o["nationId"], o["groupId"], o["teamId"]) if v != None] if o["teamId"] != "laios" else ["rhodes", "laios"]
    ops[id] = {
            "name": o["name"],
            "class": o["profession"],
            ...
            "faction": factions[0],
            "subfaction": factions[1] if len(factions) > 1 else ""
        }
